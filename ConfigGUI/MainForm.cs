...
namespace fCraft.ConfigGUI {
    ...
    public sealed partial class MainForm : Form {
        ...
        private readonly UpdaterSettingsPopup updaterWindow = new UpdaterSettingsPopup();
...
Your rank is {RANK}&S. Type &H/Help&S for help." );
        ...
        private BindingList<string> rankNameList;
        ...
        private void nKickIdle_ValueChanged( object sender, EventArgs e ) {
            if ( selectedRank == null || !xKickIdle.Checked )
                return;
        ...
        private void nAntiGriefBlocks_ValueChanged( object sender, EventArgs e ) {
            if ( selectedRank == null || !xAntiGrief.Checked )
                return;
        ...
        private void nDrawLimit_ValueChanged( object sender, EventArgs e ) {
            if ( selectedRank == null || !xDrawLimit.Checked )
                return;
        ...
        #endregion Ranks Input Handlers
        ...
        #endregion Apply / Save / Cancel Buttons
        ...
        private int colorSys, colorSay, colorHelp, colorAnnouncement, colorPM, colorIRC, colorMe, colorWarning, colorCustom;
        ...
        internal static void HandleWorldRename( string from, string to ) {
            if ( instance.cMainWorld.Items.Count == 0 )
                return;
        ...
        private readonly Dictionary<Permission, PermissionLimitBox> permissionLimitBoxes = new Dictionary<Permission, PermissionLimitBox>();
        ...
        private void CustomAliases_TextChanged( object sender, EventArgs e ) {
        }

        private void SwearBox_TextChanged( object sender, EventArgs e ) {
        }

        private void MaxCapsValue_ValueChanged( object sender, EventArgs e ) {
        }
