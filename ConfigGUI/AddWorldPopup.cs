...
namespace fCraft.ConfigGUI {
    ...
    sealed partial class AddWorldPopup : Form {
        ...
        private readonly BackgroundWorker bwLoader = new BackgroundWorker(),
        ...
        private readonly object redrawLock = new object();
        ...
        private bool floodBarrier;
        private string originalWorldName;
        private readonly List<WorldListEntry> copyOptionsList = new List<WorldListEntry>();
        private Tabs tab;
        ...
        private void LoadMap( object sender, EventArgs args ) {
        ...
        #endregion Loading/Saving Map

        #region Map Preview

        private IsoCat renderer;

        private void Redraw( bool drawAgain ) {
            lock ( redrawLock ) {
                progressBar.Visible = true;
        ...
        private void AsyncDrawCompleted( object sender, RunWorkerCompletedEventArgs e ) {
            stopwatch.Stop();
        ...
        private MapGeneratorArgs generatorArgs = new MapGeneratorArgs();
        ...
        private void AsyncGenProgress( object sender, ProgressChangedEventArgs e ) {
            progressBar.Value = e.ProgressPercentage;
            tStatus1.Text = ( string )e.UserState;
        }

        private void AsyncGenCompleted( object sender, RunWorkerCompletedEventArgs e ) {
            stopwatch.Stop();
            if ( Map == null ) {
        ...
        private static void MapDimensionValidating( object sender, CancelEventArgs e ) {
...
{5}: {6}";
        ...
        private readonly SaveFileDialog savePreviewDialog = new SaveFileDialog();
        ...
        private readonly OpenFileDialog browseTemplateDialog = new OpenFileDialog();
        ...
        private void LoadGeneratorArgs() {
            ...
            if ( generatorArgs.UseBias )
                sBias.Value = ( int )( generatorArgs.Bias * 100 );
            else
                sBias.Value = 0;
        ...
        private void SaveGeneratorArgs() {
        ...
        private readonly SaveFileDialog saveTemplateDialog = new SaveFileDialog();
        ...
        private static float TrackBarToExponent( TrackBar bar ) {
        ...
        private static int ExponentToTrackBar( TrackBar bar, float val ) {
            if ( val >= 1 ) {
