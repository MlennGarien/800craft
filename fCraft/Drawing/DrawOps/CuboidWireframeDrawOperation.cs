    ...
    public sealed class CuboidWireframeDrawOperation : DrawOperation {
        ...
        private IEnumerable<Vector3I> BlockEnumerator() {
            ...
            if ( Bounds.XMin != Bounds.XMax )
                yield return new Vector3I( Bounds.XMax, Bounds.YMin, Bounds.ZMin );
            if ( Bounds.YMin != Bounds.YMax )
                yield return new Vector3I( Bounds.XMin, Bounds.YMax, Bounds.ZMin );
            ...
            if ( Bounds.Height > 2 ) {
                for ( int z = Bounds.ZMin + 1; z < Bounds.ZMax; z++ ) {
                    ...
                    if ( Bounds.YMin != Bounds.YMax )
                        yield return new Vector3I( Bounds.XMin, Bounds.YMax, z );
                    if ( Bounds.XMin != Bounds.XMax ) {
                        yield return new Vector3I( Bounds.XMax, Bounds.YMax, z );
                        if ( Bounds.YMin != Bounds.YMax )
                            yield return new Vector3I( Bounds.XMax, Bounds.YMin, z );
                    }
                }
            }
        }
