...
namespace fCraft.Drawing {
    ...
    public sealed class Fill2DDrawOperation : DrawOpWithBrush {
        ...
        private IEnumerable<Vector3I> BlockEnumeratorX() {
        ...
        private IEnumerable<Vector3I> BlockEnumeratorY() {
            Stack<Vector3I> stack = new Stack<Vector3I>();
            stack.Push( Origin );
            Vector3I coords;
        ...
        private IEnumerable<Vector3I> BlockEnumeratorZ() {
            Stack<Vector3I> stack = new Stack<Vector3I>();
            stack.Push( Origin );
            Vector3I coords;
