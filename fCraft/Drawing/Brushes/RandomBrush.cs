...
namespace fCraft.Drawing {
    ...
    public sealed class RandomBrushFactory : IBrushFactory {
        ...
        private const string HelpString = "Random brush: Chaotic pattern of two or more random block types. " +
    ...
    public unsafe sealed class RandomBrush : IBrushInstance, IBrush {
        ...
        private readonly Block[] actualBlocks;
