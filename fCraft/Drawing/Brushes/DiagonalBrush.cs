...
namespace fCraft.Drawing {
    ...
    public sealed class DiagonalBrushFactory : IBrushFactory {
        ...
        private const string HelpString = "Diagonal brush: Fills the area with in a diagonal pattern of 2 block types. " +
        ...
        public IBrush MakeBrush( [NotNull] Player player, Command cmd ) {
            ...
            if ( !cmd.HasNext ) {
                if ( player.LastUsedBlockType != ( Block )255 )
                    ...
                    return new DiagonalBrush( new[] { Block.Stone } );
            }
