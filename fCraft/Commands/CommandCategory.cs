...
namespace fCraft {
    ...
    public enum CommandCategory {
		...
		/// <summary> Commands for drawing function surfaces or parametrized multifolds. </summary>
        Math = 256,

		/// <summary> Commands for entertaining commands like games, chat fun, etc. </summary>
		Fun = 512,
    }
}
