...
namespace fCraft {
    ...
    public static class IPBanList {
        private static readonly SortedDictionary<string, IPBanInfo> Bans = new SortedDictionary<string, IPBanInfo>();
        private static readonly object BanListLock = new object();

        #region Loading/Saving

        private const string Header = "IP,bannedBy,banDate,banReason,playerName,attempts,lastAttemptName,lastAttemptDate";
        ...
        private static int ParseHeader( [NotNull] string header ) {
            if ( header == null )
        ...
        private static bool RaiseAddingIPBanEvent( [NotNull] IPBanInfo info ) {
            if ( info == null )
