...
namespace fCraft {
    ...
    public static class Heartbeat {
        private static readonly Uri MinecraftNetUri;
        ...
        private static HttpWebRequest minecraftNetRequest;

        private static void SendMinecraftNetBeat() {
        ...
        private static void RaiseUriChangedEvent( Uri oldUri, Uri newUri ) {
            var h = UriChanged;
            if ( h != null )
                h( null, new UriChangedEventArgs( oldUri, newUri ) );
        }
