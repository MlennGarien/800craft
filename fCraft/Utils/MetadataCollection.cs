...
namespace fCraft {
    ...
    public sealed class MetadataCollection<TValue> : ICollection<MetadataEntry<TValue>>, ICollection, ICloneable, INotifiesOnChange where TValue : class {
        private readonly Dictionary<string, Dictionary<string, TValue>> store = new Dictionary<string, Dictionary<string, TValue>>();
        ...
        #endregion Count / Group Count / Key Count
        ...
        private TValue GetValue( [NotNull] string group, [NotNull] string key ) {
            if ( group == null )
                throw new ArgumentNullException( "group" );
            if ( key == null )
                throw new ArgumentNullException( "key" );
        ...
        private void SetValue( [NotNull] string group, [NotNull] string key, [NotNull] TValue value ) {
            if ( group == null )
                throw new ArgumentNullException( "group" );
            if ( key == null )
                throw new ArgumentNullException( "key" );
        ...
        #endregion Contains Group / Key / Value
        ...
        #endregion ICollection<MetadataEntry> Members
        ...
        #endregion IEnumerable<MetadataEntry> Members
