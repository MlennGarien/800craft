...
namespace fCraft {
    ...
    public sealed class Noise {
        ...
        private readonly float[,] points = new float[4, 4];
        ...
        private static unsafe void Normalize( float* ptr, int length, float low, float high ) {
            float min = float.MaxValue,
                  max = float.MinValue;
        ...
        private const float BoxBlurDivisor = 1 / 23f;
        ...
        private const float GaussianBlurDivisor = 1 / 273f;
        ...
        private const int ThresholdSearchPasses = 10;
