...
namespace fCraft {
    ...
    public sealed class MapGenerator {
        ...
        private float[,] heightmap, blendmap, slopemap;

        private const float CliffsideBlockThreshold = 0.01f;

        // theme-dependent vars
        private Block bWaterSurface, bGroundSurface, bWater, bGround, bSeaFloor, bBedrock, bDeepWaterSurface, bCliff;
        ...
        private const int FlatgrassDirtLevel = 5;
        ...
        private int progressTotalEstimate, progressRunningTotal;
        ...
        private void ReportProgress( int relativeIncrease, [NotNull] string message ) {
            if ( message == null )
        ...
        #endregion Heightmap Processing
        ...
        private static void AddSingleVein( Random rand, Map map, byte bedrockType, byte fillingType, int k, double maxDiameter, int l, int i1 ) {
