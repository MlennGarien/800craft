...
namespace fCraft {
    ...
    public static class Forester {
        ...
        private sealed class NormalTree : StickTree {
        ...
        private sealed class BambooTree : StickTree {
        ...
        private sealed class PalmTree : StickTree {
        ...
        private class ProceduralTree : Tree {
            ...
            private void FoliageCluster( Vector3I center ) {
                int z = center[1];
            ...
            private void TaperedLimb( Vector3I start, Vector3I end, float startSize, float endSize ) {
        ...
        private class RoundTree : ProceduralTree {
        ...
        private sealed class ConeTree : ProceduralTree {
        ...
        private sealed class RainforestTree : ProceduralTree {
        ...
        private sealed class MangroveTree : RoundTree {
        ...
        private static int DistanceToBlock( Map map, Vector3F coord, Vector3F vec, Block blockType ) {
            return DistanceToBlock( map, coord, vec, blockType, false );
        }

        private static readonly Vector3F HalfBlock = new Vector3F( .5f, .5f, .5f );

        private static int DistanceToBlock( Map map, Vector3F coord, Vector3F vec, Block blockType, bool invert ) {
            coord += HalfBlock;
            int iterations = 0;
        ...
        private static float Cub( float val ) {
            return val * val * val;
        }
