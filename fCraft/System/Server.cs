...
namespace fCraft
{
    /// <summary> Core of an 800Craft server. Manages startup/shutdown, online player
    ...
    public static partial class Server
    {
        ...
        /// <summary> Produces a string containing all recognized arguments that wereset/passed to this instance of 800Craft. </summary>
        ...
        /// <summary> Produces a list of arguments that were passed to this instance of 800Craft. </summary>
        ...
        public static void InitServer()
        {
            ...
            if (Updater.CurrentRelease.IsFlagged(ReleaseFlags.Dev))
            {
                Logger.Log(LogType.Warning,
                            ...
                            "Consider using the lastest stable version instead, available from github.com/glennmr/800craft/downloads");
            }
