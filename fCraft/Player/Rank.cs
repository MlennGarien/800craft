...
namespace fCraft {
    ...
    public sealed class Rank : IClassy, IComparable<Rank> {
        ...
        public XElement Serialize() {
            ...
            if ( ReservedSlot )
                rankTag.Add( new XAttribute( "reserveSlot", ReservedSlot ) );
        ...
        #endregion Rank Comparison Operators
        ...
        public static bool IsValidRankName( [NotNull] string rankName ) {
            ...
            if ( rankName.Length < 1 || rankName.Length > 16 )
                return false;
