...
namespace fCraft.MapConversion {
    ...
    public class NBTag : IEnumerable<NBTag> {
        ...
        private NBTag( NBTType type, NBTag parent ) {
            Type = type;
            Parent = parent;
        }
        ...
        #endregion Shorthand Contructors
        ...
        #endregion Child Tag Manipulation
        ...
        private static void WriteString( [NotNull] string str, [NotNull] BinaryWriter writer ) {
            if ( str == null )
        ...
        private object GetChild( string name, object defaultValue ) {
